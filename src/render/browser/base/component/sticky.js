...
function setSticky (sticky) {
  ...
  comp.stickyPlaceholder.classList.add('jud-sticky-placeholder')
  element.classList.add('jud-sticky')
...
function unsetSticky (sticky, position) {
  ...
  element.classList.remove('jud-sticky')
...
/**
 * @class  Sticky
 * @param {Component} component: a jud component.
