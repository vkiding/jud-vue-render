...
const proto = {
  create () {
    ...
    node.classList.add('jud-spinner-wrap')
    this.spinner = document.createElement('div')
    this.spinner.classList.add('jud-element')
    this.spinner.classList.add('jud-spinner')
...
//     this.setKeyframeColor(global.jud.utils.getRgb(this.node.style.color))
//   }
// }
