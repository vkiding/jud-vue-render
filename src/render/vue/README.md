# Vue Web Renderer for Jud

This is a group of Vue 2.x components for Jud, which have the same behavior with the Jud built-in components on the native.

It can be run on browser only based on Vue 2.x (without Jud).
